...
function ScoreSubmissionBanner({
  ...
  if (hasConflict) {
    message = `Conflicting scores submitted — organizer review pending. Yours: ${mySubmission?.homeScore}–${mySubmission?.awayScore} vs ${otherSubmission?.submittedBy.name}: ${otherSubmission?.homeScore}–${otherSubmission?.awayScore}.`;
    tone = "warning";
  } else if (
    mySubmission &&
    otherSubmission &&
